...
# Expects empty folders named 1px_ATy, where 1p2=1.2 distance threshold, e.g., and AT10 = 10 degrees alignment thresholding
...
for dist_t in dist_thresholds:
    ...
    for align_t in align_thresholds:
        ...
        if align_t == 0:
            ...
            ang_files = glob.glob("../SimAngNPY/*.npy")
